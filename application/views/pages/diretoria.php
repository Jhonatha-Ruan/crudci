	...
	<div class="table-responsive">
        ...
        <div class="input-group mb-2">
            <div class="input-group-prepend">
                ...
                <form action="<?=base_url()?>diretoria/searchDiretoria" method="post">
          ...
          <tr>
			...
			<div class="modal" id="myModal<?= $b['id'] ?>">
				<div class="modal-dialog">
					...
					<div class="modal-footer">
						...
						<a href="<?=base_url()?>diretoria/delete/<?=$b["id"]?>" class="btn btn-danger">Remover</a>
					</div>
			...
			<div class="modal" id="modalEdit<?= $b['id'] ?>">
				...
				<div class="modal-dialog">
					...
					<!-- Modal body -->
					<div class="modal-body">
						<form action="<?=base_url()?>diretoria/update/<?=$b["id"]?>" method="post">
...
<div class="modal" id="modalCadastro">
	<div class="modal-dialog">
		...
		<!-- Modal body -->
		<div class="modal-body">
			<form action="<?= base_url() ?>diretoria/novoBoletim" method="post">
